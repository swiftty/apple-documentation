...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/kean/Nuke.git", from: "12.8.0", traits: [.defaults]),
        .package(url: "https://github.com/apple/swift-algorithms.git", from: "1.2.1"),
        .package(url: "https://github.com/firebase/firebase-ios-sdk.git", from: "12.9.0"),

        .package(url: "https://github.com/apple/swift-syntax.git", from: "602.0.0"),

        .package(url: "https://github.com/swiftty/XcodeGenBinary.git", from: "2.44.1"),
        .package(url: "https://github.com/swiftty/SwiftLintBinary.git", exact: "0.62.2")
    ],
    targets: [
        .target(
